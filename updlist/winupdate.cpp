...
//	fver _dmusic_sys_cache   = getFileVer(DriverCache+L"\\dmusic.sys",&status);
	...
	fver _wbemcntl_dll = getFileVer(wbem+L"\\wbemcntl.dll",&status);
...
//	   || (_sysmain_sdb  >zero && _sysmain_sdb  <fver())
	...
	if((sp==1 && qfe && (sku & XP_ALL) && _winhttp_dll>zero && _winhttp_dll<fver(5,1,2600,1838))
	 /*||(sp==2 && qfe && (sku & XP_ALL) && _winhttp_dll>zero && _winhttp_dll<fver(5,1,2600,2904))*/) {
		...
		XX(q3+"WindowsXP-KB899900-x86-ENU.exe"+a1);
	}
	/*if( sp==2 && qfe && (sku & XP_ALL) && _winhttp_dll>zero && _winhttp_dll<fver(5,1,2600,2805)) {
		...
		XX(q3+"WindowsXP-KB909425-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _winhttp_dll>zero && _winhttp_dll<fver(5,1,2600,2911)) {
		NN("Update for Windows XP (KB919477)"); // KB919477 is replaced by KB971737
		XX(q3+"WindowsXP-KB919477-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _rpcrt4_dll >zero && _rpcrt4_dll <fver(5,1,2600,2863)) {
		NN("Update for Windows XP (KB916189)"); // KB916189 is replaced by KB970238
		XX(q3+"WindowsXP-KB916189-v2-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _dhcpcsvc_dll >zero && _dhcpcsvc_dll <fver(5,1,2600,2629)) {
		...
		XX(q3+"WindowsXP-KB895246-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _dhcpcsvc_dll >zero && _dhcpcsvc_dll <fver(5,1,2600,2794)) {
		...
		XX(q3+"WindowsXP-KB906650-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _dhcpcsvc_dll >zero && _dhcpcsvc_dll <fver(5,1,2600,2855)) {
		NN("Update for Windows XP (KB915357)"); // KB915357 is replaced by KB914388(5,1,2600,2912)
		XX(q3+"WindowsXP-KB915357-x86-ENU.exe"+a1);
	}*/
	if( sp==2 && qfe && (sku & XP_ALL) && _dhcpcsvc_dll >zero && _dhcpcsvc_dll <fver(5,1,2600,2951)) {
		NN("Update for Windows XP (KB919250)");
		XX(q3+"WindowsXP-KB919250-x86-ENU.exe"+a1);
	}
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _spoolss_dll >zero && _spoolss_dll <fver(5,1,2600,2785)) {
		NN("Update for Windows XP (KB909987)"); // KB909987 is replaced by KB917777
		XX(q3+"WindowsXP-KB909987-x86-ENU.exe"+a1);
	}*/
	if( sp==2 && qfe && (sku & XP_ALL) && _spoolss_dll >zero && _spoolss_dll <fver(5,1,2600,3008)) {
		NN("Update for Windows XP (KB917777)");
		XX(q3+"WindowsXP-KB917777-v2-x86-ENU.exe"+a1);
	}
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _pdh_dll >zero && _pdh_dll <fver(5,1,2600,2874)) {
		NN("Update for Windows XP (KB917022)"); // KB917022 is replaced by KB956572(5,1,2600,3536)
		XX(q3+"WindowsXP-KB917022-x86-ENU.exe"+a1);
	}*/
	if((sp==1 && qfe && (sku & XP_ALL) && (
...
//					  ||  (_t2embed_dll>zero && _t2embed_dll<fver(5,1,2600,2777)) )) {
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _rastls_dll >zero && _rastls_dll <fver(5,1,2600,2859) ) {
		NN("Update for Windows XP (KB915832)"); // KB915832 is replaced by KB974318
		XX(q3+"WindowsXP-KB915832-x86-ENU.exe"+a1);
	}*/
...
//	   || (_ipseccmd_exe >zero && _ipseccmd_exe <fver(5,1,2600,1240))
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && (
	   (_shell32_dll  >zero && _shell32_dll  <fver(6,0,2900,2988))
	|| (_shsvcs_dll   >zero && _shsvcs_dll   <fver(6,0,2900,2988))
	|| (_xpsp3res_dll >zero && _xpsp3res_dll <fver(5,1,2600,2988)) )) {
		NN("Update for Windows XP (KB918649)"); // KB918649 is replaced by KB928255
		XX(q3+"WindowsXP-KB918649-v4-x86-ENU.exe"+a1);
	}*/
	if( sp==2 && (sku & XP_ALL) && (
	   (_shell32_dll  >zero && _shell32_dll  <fver(6,0,2900,3051))
	|| (_shsvcs_dll   >zero && _shsvcs_dll   <fver(6,0,2900,3051))
	|| (_xpsp3res_dll >zero && _xpsp3res_dll <fver(5,1,2600,3051)) )) { // QFE only
		NN("Security Update for Windows XP (KB928255)");
		XX(p3+"windowsxp-kb928255-x86-enu_d29dfbbe228e49f746a947eeb4880e980b76d53d.exe"+a1);
	}
	/*if( sp==2 && qfe && (sku & XP_ALL) && (
...
//		     || (_spupdsvc_exe >zero && _spupdsvc_exe <fver(6,2,29,0))
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _videoprt_sys >zero && _videoprt_sys <fver(5,1,2600,2911)) {
		NN("Update for Windows XP (KB917332)"); // KB912112 is replaced by KB960921
		XX(q3+"WindowsXP-KB917332-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _videoprt_sys >zero && _videoprt_sys <fver(5,1,2600,3147)) {
		...
		XX(q3+"WindowsXP-KB937930-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && (sku & XP_ALL) && (
		 ( _usbser_sys   >zero && _usbser_sys   <fver(5,1,2600,2930))
		||(_usbser_sys_cache  <fver(5,1,2600,2930)) )) {
		NN("Update for Windows XP (KB918365)"); // KB918365 is replaced by KB918365
		XX(q3+"WindowsXP-KB918365-x86-ENU.exe"+a1);
	}*/
	if( sp==2 && (sku & XP_ALL) && (
		 ( _usbser_sys   >zero && _usbser_sys   <fver(5,1,2600,3234))
		||(_usbser_sys_cache  <fver(5,1,2600,3234)) )) {
		NN("Update for Windows XP (KB943198)");
		XX(p3+"WindowsXP-KB943198-v2-x86-ENU.exe"+a1);
	}
	if( sp==3 && (sku & XP_ALL) && (
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && (
		  ( _unidrv_dll   >zero && _unidrv_dll   <fver(0,3,3790,525))
	  ||  ( _unidrv_dll_cache   <fver(0,3,3790,525)))) {
		NN("Update for Windows XP (KB914929)"); // KB914929 is replaced by KB948046
		XX(q3+"WindowsXP-KB914929-v4-x86-ENU.exe"+a1);
	}*/
	if( sp>=2 && qfe && (sku & XP_ALL) && (
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && (
		 ( _usbhub_sys   >zero && _usbhub_sys   <fver(5,1,2600,2980)) )) {
		NN("Update for Windows XP (KB920875)"); // KB920875 is replaced by KB949483
		XX(q3+"WindowsXP-KB920875-x86-ENU.exe"+a1);
	}*/
	if( sp==2 && qfe && (sku & XP_ALL) && (
		 ( _usbhub_sys   >zero && _usbhub_sys   <fver(5,1,2600,3325)) )) {
		NN("Update for Windows XP (KB949483)");
		XX(q3+"WindowsXP-KB949483-x86-ENU.exe"+a1);
	}
	if((sp==2 && qfe && (sku & XP_ALL) && (
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _cimwin32_dll >zero && _cimwin32_dll <fver(5,1,2600,2864)) {
		NN("Update for Windows XP (KB916191)"); // KB916191 is replaced by KB955988
		XX(q3+"WindowsXP-KB916191-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _msctfime_ime <fver(5,1,2600,2649)) {
		...
		XX(q3+"WindowsXP-KB896684-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _msctfime_ime <fver(5,1,2600,2657)) {
		...
		XX(q3+"WindowsXP-KB895564-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _msctfime_ime <fver(5,1,2600,2926)) {
		NN("Update for Windows XP (KB920889)"); // KB920889 is replaced by KB961503
		XX(q3+"WindowsXP-KB920889-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _userenv_dll >zero && _userenv_dll <fver(5,1,2600,2736)) {
		...
		XX(q3+"WindowsXP-KB903242-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && (
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _ntdll_dll >zero && _ntdll_dll <fver(5,1,2600,2932)) {
		NN("Update for Windows XP (KB921321)"); // KB921321 is replaced by KB956572 (5,1,2600,3520)
		XX(q3+"WindowsXP-KB921321-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _userenv_dll >zero && _userenv_dll <fver(5,1,2600,2872)) {
		...
		XX(q3+"WindowsXP-KB906469-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _win32k_sys>zero && _win32k_sys<fver(5,1,2600,2868)) {
		NN("Update for Windows XP (KB916199)"); // KB916199 is replaced by KB979559
		XX(q3+"WindowsXP-KB916199-v2-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _win32k_sys>zero && _win32k_sys<fver(5,1,2600,2989)) {
		NN("Update for Windows XP (KB920192)"); // KB920192 is replaced by KB979559(5,1,2600,3706)
		XX(q3+"WindowsXP-KB920192-x86-ENU.exe"+a1);
	}*/
...
//	   || (_oeupdate_exe >zero && _oeupdate_exe <fver(6,0,2800,1276))
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && (_iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)) && (
		...
		XX(q3+"WindowsXP-KB906473-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && (_iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)) && (
		   ( _shdocvw_dll >zero && _shdocvw_dll <fver(6,0,2900,2936)) )) {
		NN("Update for Windows XP (KB920982)"); // KB920982 is replaced by KB958215 (6,0,2900,3462)
		XX(q3+"WindowsXP-KB920982-x86-ENU.exe"+a1);
	}*/
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _wininet_dll >zero && _wininet_dll <fver(6,0,2900,2859)) {
		NN("Update for Windows XP (KB915686)"); // KB915686 is replaced by KB958215
		XX(q3+"WindowsXP-KB915686-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
		...
		XX(q3+"WindowsXP-KB908209-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _wininet_dll >zero && _wininet_dll <fver(6,0,2900,2961)) {
		NN("Update for Windows XP (KB921400)"); // KB921400 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB921400-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _wininet_dll >zero && _wininet_dll <fver(6,0,2900,3073)) {
		NN("Update for Windows XP (KB920605)"); // KB920605 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB920605-v2-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _wininet_dll >zero && _wininet_dll <fver(6,0,2900,3118)) {
		NN("Update for Windows XP (KB915787)"); // KB915787 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB915787-v4-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
		...
		NN("Update for Windows XP (KB917772)"); // KB917772 is replaced by KB958215(6,0,2900,3462)
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2910)) {
		NN("Update for Windows XP (KB918967)"); // KB918967 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB918967-v2-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2936)) {
		NN("Update for Windows XP (KB920681)"); // KB920681 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB920681-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2961)) {
		NN("Update for Windows XP (KB885439)"); // KB885439 is replaced by KB958215
		XX(q3+"WindowsXP-KB885439-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2961)) {
		NN("Update for Windows XP (KB921397)"); // KB921397 is replaced by KB958215
		XX(q3+"WindowsXP-KB921397-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
		   && _mshtml_dll   >zero && _mshtml_dll   <fver(6,0,2900,2992)) {
		NN("Update for Windows XP (KB918310)"); // KB918310 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB918310-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
		   && _mshtml_dll   >zero && _mshtml_dll   <fver(6,0,2900,2992)) {
		NN("Update for Windows XP (KB918966)"); // KB918966 is replaced by KB958215(6,0,2900,3462)
		XX(q3+"WindowsXP-KB918966-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && (_iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)) && (
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
		...
		XX(q3+"WindowsXP-KB889407-x86-ENU.exe"+a6);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && (_iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)) && (
		...
		XX(q3+"WindowsXP-KB892056-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2737)) {
		NN("Update for Windows XP (KB905299)"); // KB905299 is replaced by KB958215
		XX(q3+"WindowsXP-KB905299-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,2991)) {
		NN("Update for Windows XP (KB918690)"); // KB918690 is replaced by KB958215
		XX(q3+"WindowsXP-KB918690-v2-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
			&& _mshtml_dll >zero && _mshtml_dll <fver(6,0,2900,3070)) {
		NN("Update for Windows XP (KB915355)"); // KB915355 is replaced by KB958215
		XX(q3+"WindowsXP-KB915355-x86-ENU.exe"+a1);
	}*/
	/*if( sp==2 && qfe && (sku & XP_ALL) && _iexplore_exe>=fver(6,0,0,0) && _iexplore_exe<fver(7,0,0,0)
...
//		   (_mshtml_dll   >zero && _mshtml_dll   <fver(6,0,2900,5726)) )) {
	...
	/*if( sp==2 && qfe && (sku & XP_ALL) && (_iexplore_exe>=fver(7,0,5730,11) && _iexplore_exe<fver(7,1,0,0))
		...
		XX(q3+"IE7-WindowsXP-KB906473-v2-x86-ENU.exe"+a1);
	}*/
