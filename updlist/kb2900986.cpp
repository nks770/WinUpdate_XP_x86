...
bool kb2900986_installed() {
	...
	test_keys.push_back(L"0D080D7D-28D2-4F86-BFA1-D582E5CE4867");
	...
	test_keys.push_back(L"1A6FE369-F28C-4AD9-A3E6-2BCB50807CF1");
	...
	test_keys.push_back(L"2745E5F5-D234-11D0-847A-00C04FD7BB08");
	...
	test_keys.push_back(L"29851043-AA76-4EFD-9232-4914DD0AD4A1");
	test_keys.push_back(L"29E9B436-DFAC-42F9-B209-BD37BAFE9317");
	test_keys.push_back(L"2C2DE2E6-2AD1-4301-A6A7-DF364858EF01");
	test_keys.push_back(L"2C37C480-CEE3-11D1-82C3-0060089253D0");
	...
	test_keys.push_back(L"3EEEBC9A-580F-46EF-81D9-55510266413D");
	...
	test_keys.push_back(L"466576F3-19B6-4FF1-BD48-3E0E1BFB96E9");
	...
	test_keys.push_back(L"4918D1BD-B497-4F2F-A429-3C3CD74694FE");
	test_keys.push_back(L"497EE41C-CE06-4DD4-8308-6C730713C646");
	test_keys.push_back(L"4A5869CF-929D-4040-AE03-FCAFC5B9CD42");
	test_keys.push_back(L"4BA9089C-DDFC-4206-B937-74484B06D305");
	...
	test_keys.push_back(L"4F496A52-13F7-483D-B5E2-0FC4AA567749");
	test_keys.push_back(L"53655704-5956-11D3-91AA-005004B34F28");
	test_keys.push_back(L"55963676-2F5E-4BAF-AC28-CF26AA587566");
	test_keys.push_back(L"5622772D-6C27-11D3-95E5-006008D14F3B");
	test_keys.push_back(L"56393399-041A-4650-94C7-13DFCB1F4665");
	test_keys.push_back(L"57733FF6-E100-4A4B-A7D1-A85AD17ABC54");
	...
	test_keys.push_back(L"6286EF1A-B56E-48EF-90C3-743410657F3C");
	...
	test_keys.push_back(L"687F154E-1099-11D4-91F9-005004B34F28");
	...
	test_keys.push_back(L"6E84D662-9599-11D2-9367-20CC03C10627");
	test_keys.push_back(L"6F225D94-9318-11D4-9223-005004B34F28");
	test_keys.push_back(L"6F750200-1362-4815-A476-88533DE61D0C");
	test_keys.push_back(L"6F750201-1362-4815-A476-88533DE61D0C");
	test_keys.push_back(L"705EC6D4-B138-4079-A307-EF13E4889A82");
	...
	test_keys.push_back(L"7A7B986C-31E9-4286-88CA-B9DC481CA989");
	test_keys.push_back(L"7B297BFD-85E4-4092-B2AF-16A91B2EA103");
	test_keys.push_back(L"7E00A3B0-8F5C-11D2-BAA4-04F205C10000");
	...
	test_keys.push_back(L"8290CB76-9F61-458B-AD2C-3F6FD2E8CD7D");
	test_keys.push_back(L"833E62AD-1655-499F-908E-62DCA1EB2EC6");
	test_keys.push_back(L"83F0C8F0-4900-4909-A0AD-A5BAAC432739");
	test_keys.push_back(L"8469A9DE-A3BF-4218-A1D2-F19AA9EA1617");
	...
	test_keys.push_back(L"9B8E377B-7291-491A-B611-BB3E1D5F99F0");
	...
	test_keys.push_back(L"A3CD4BF9-EC17-47A4-833C-50A324D6FF35");
	...
	test_keys.push_back(L"AC146530-87A5-11D1-ADBD-00AA00B8E05A");
	...
	test_keys.push_back(L"B34B19F4-7EBE-46CB-807C-746E72EBB4B6");
	test_keys.push_back(L"B3F90F4F-B521-4C76-BE28-DB569320CB8F");
	test_keys.push_back(L"B4CB50E4-0309-4906-86EA-10B6641C8392");
	...
	test_keys.push_back(L"B8E73359-3422-4384-8D27-4EA1B4C01232");
	...
	test_keys.push_back(L"C679DECC-5289-4856-B504-74B11ADD424A");
	...
	test_keys.push_back(L"CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA");
	test_keys.push_back(L"CB05A177-1069-4A7A-AB0A-5E6E00DCDB76");
	test_keys.push_back(L"CC679CB8-DC4B-458B-B817-D447B3B6AC31");
	...
	test_keys.push_back(L"DD7B057D-9020-4630-BAF8-7A0CDA04588D");
	...
	test_keys.push_back(L"F8FC1530-0608-11DF-2008-0800200C9A66");
	test_keys.push_back(L"F9769A06-7ACA-4E39-9CFB-97BB35F0E77E");
	test_keys.push_back(L"FA44198C-E0B3-4F10-8B77-F646EC7CE684");
	...
	test_keys.push_back(L"FB7199AB-79BF-11D2-8D94-0000F875C541");
	test_keys.push_back(L"FB7FE605-A832-11D1-88A8-0000E8D220A6");
	test_keys.push_back(L"FC28B75F-F9F6-4C92-AF91-14A3A51C49FB");
	test_keys.push_back(L"FC7F9CC6-E049-4698-8A25-59AD87C7DCE2");
	test_keys.push_back(L"FF371BF4-213D-11D0-95F3-00C04FD9B15B");
	...
	test_keys.clear();
	test_keys.push_back(L"19916E01-B44E-4E31-94A4-4696DF46157B");
	test_keys.push_back(L"33FDA1EA-80DF-11D2-B263-00A0C90D6111");
	test_keys.push_back(L"476C391C-3E0D-11D2-B948-00C04FA32195");
	test_keys.push_back(L"53001F3A-F5E1-4B90-9C9F-00E09B53C5F1");
	test_keys.push_back(L"C2C4F00A-720E-4389-AEB9-E9C4B0D93C6F");

	for(unsigned int i=0; i<test_keys.size(); i++) {
		CompatibilityFlags=regQueryDWORD(ActiveX+test_keys[i]+L"}",L"Compatibility Flags",&status);
		if(CompatibilityFlags != 67109888){
			//printf("%ls: #%d#\n",test_keys[i].c_str(),CompatibilityFlags);
			installed=false;
		}
	}
